...
"}")
        ...
        self.gridLayout.addWidget(self.btn_work, 13, 1, 1, 3)
...
"border:none;")
        ...
        self.gridLayout.addWidget(self.label_err, 15, 0, 1, 4)
        ...
        self.btn_rotate_plus.setFont(font1)
...
"}")
        icon = QIcon()
        icon.addFile(u"C:/Users/Klen/.designer/backup/icons8-rotate-right-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_rotate_plus.setIcon(icon)
        ...
        font2.setBold(True)
        self.btn_zoom_plus.setFont(font2)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u"C:/Users/Klen/.designer/backup/icons8-zoom-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_zoom_plus.setIcon(icon1)
        ...
        self.btn_zoom_minus.setFont(font2)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u"C:/Users/Klen/.designer/backup/icons8-zoom-out-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_zoom_minus.setIcon(icon2)
        ...
        self.btn_rotate_minus.setFont(font2)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u"C:/Users/Klen/.designer/backup/icons8-rotate-left-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_rotate_minus.setIcon(icon3)
        ...
        self.gridLayout.addWidget(self.frame_3, 17, 0, 1, 4)
